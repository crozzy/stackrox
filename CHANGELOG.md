...
- Introduction of `--image-default=opensource` to `roxctl generate` commands. This will default image registries to the public Open Source images at `quay.io/stackrox-io`.
